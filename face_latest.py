...
video_capture = cv2.VideoCapture("/home/nihal/Prakash/face_recognition/man_video.mp4")
output = cv2.VideoWriter('output.mp4',cv2.VideoWriter_fourcc(*'MP4V'),25,(720,640))
